...
// <div :class="uniqueClasses(self.containerClasses)" ref="swiperElRef">
//   <slot name="container-start" />
//   <template v-if="needsNavigation(props)">
//     <button ref="prevElRef" class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
//             <span class="carousel-control-prev-icon" aria-hidden="true" />
//           </button>
//           <button ref="nextElRef" class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next" >
//             <span class="carousel-control-next-icon" aria-hidden="true" />
//           </button>
//   </template>
//   <div ref="scrollbarElRef" class="swiper-scrollbar" v-if="needsScrollbar(props)"/>
//   <div ref="paginationElRef" class="swiper-pagination" v-if="needsPagination(props)"/>
//   <div class="swiper-wrapper">
//     <slot name="wrapper-start" />
//     <template v-if="renderSlides(slides)) || (" />
  ...
  render (h) {
    ...
    return h(
      ...
      [
        ...
        h('div', {
          staticClass: 'inner-header d-flex mb-1 align-center justify-content-between'
        }, [(props.title) && h('h4', {
          staticClass: 'inner-heading'
        }, [props.title]), h('div', [h(
          'router-link', {
            attrs: {
              'to': '/'
        ...
        needsPagination(props) && h('div', { ref: 'paginationElRef', class: 'carousel-indicators' }),
