<template>
  <div id="category">
    <category-header
      ...
      subtitle="DeWalt Power Detect Technology Marks the Brand’s <br> Entry in Advanced 20V Max Tools"
    />
    <div class="container pb60">
      <div class="row m0 pt15">
        ...
        <div class="col-md-9 px10 border-box products-list">
          <div class="list-header d-flex justify-content-between align-center mb-4">
            <div class="left">
              <breadcrumbs />
            ...
            <div class="right d-flex">
              ...
              <button type="button" class="btn btn-light me-2">
                <i class="bi bi-grid ic-active" />
              </button>
              <button type="button" class="btn btn-light">
                <i class="bi bi-list ic-active" />
              </button>
            </div>
          </div>
...
import CategoryHeader from 'theme/components/molecules/category-header';
