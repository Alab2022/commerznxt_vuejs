<template>
  <div class="site-wrapper">
    <section>
      ...
      <div class="container">
        <section class="row m0 between-xs">
          ...
          <div class="col-xs-12 col-md-5 data pdt-detail-wrapper">
            <h5>
            ...
            <div class="ratings mb-2">
              <i class="bi bi-star-fill ic-active" />
              <i class="bi bi-star-fill ic-active" />
              <i class="bi bi-star-fill ic-active" />
              <i class="bi bi-star-fill" />
              <i class="bi bi-star-fill" />
              <span class="cm-light">1920 Comments</span>
            </div>
            <div class="brand d-flex align-center" :content="getCurrentProduct.sku">
              <p class="me-3">
                Brand: 3M | {{ $t('SKU: {sku}', { sku: getCurrentProduct.sku }) }}
              </p>
              <div v-if="!isStockInfoLoading"
                   :class="['stock-btn',maxQuantity>0?'success':'error' ]"
              >
            ...
            <product-custom-options
              ...
              :product="getCurrentProduct"
            />
            <div class="detail-btn-wrp d-flex align-center mb-4">
              <product-quantity
            ...
            <div class="row py40 add-to-buttons" v-if="false">
              <div class="col-xs-6 col-sm-3 col-md-6">
                <AddToCompare :product="getCurrentProduct" />
              </div>
            </div>
            <div class="description">
              <h6>{{ $t('Short Description') }}</h6>
              <p>
                Available in a range of 3 easily identifiable colour coded sizes
                All sizes feature an injection port to aid the administering process
                Allow easy administering of medications
                Each cannulae has a standard luer slip connector
                Sold singly
              </p>
    ...
    <section class="container px15 pt50 pb35 cl-accent details" v-if="false">
...
import RecentProduct from 'theme/components/molecules/recent-product';
